...
final class Session {
    ...
    //uzimaju kljuceve i vracaju true or false
    public function exists(string $key): bool{
        return isset($this->sessionData->$key);
    }
    
    //vraca true jedino ako vrednost ostoji i ako nije jednaka null
    ...
    public function reload(){
        ...
        if ($currentFingerprint !== $savedFingerprint) {
            $this->clear(); //ako se desi hajdzekovanje prekida se napad, stiti od napada
